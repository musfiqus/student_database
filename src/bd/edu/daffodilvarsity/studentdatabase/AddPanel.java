...
public class AddPanel extends javax.swing.JPanel {
    ...
    private boolean isValidGrade(String str) {
        ...
        if(isDouble) {
            ...
            if(grade == 0.0d || grade == 2.0d || grade == 2.25d || grade == 2.5d || grade == 2.75d || grade == 3.0d || grade == 3.25d || grade == 3.5d || grade == 3.75d || grade == 4.0d) {
                return true;
            }
            return false;
        }
    ...
    private void generateRemarks() {
        ...
        double cgpa = ((mainPoints*3) + (labPoints*1)) / 14;
        if(cgpa == 0.0) {
    ...
    private void errorDialogueTwoButtonDrop(String messageString) {
        ...
        switch (n) {
            case JOptionPane.OK_OPTION: this.dataLoader.dropStudent(this.dataLoader.getCurrentStudentIndex());
                                        ...
                                        panelVisiblity(true, false, false, false);
                                        break;
            case JOptionPane.CANCEL_OPTION: //CANCEL CODE
                                        break;
            default: //DO NOTHING JUST DISPLAY MESSAGE
                                        break;
        }
    }  
}
